...
namespace DoAnNhom6.Areas.Admin.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public MenusController(DoAnNhom6Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MenuId,Name,Alias,Description,Position,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,IsActive")] TblMenu tblMenu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuId,Name,Alias,Description,Position,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,IsActive")] TblMenu tblMenu)
        {
